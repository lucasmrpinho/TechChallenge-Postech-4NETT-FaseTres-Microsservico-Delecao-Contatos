...
using Postech.GroupEight.TechChallenge.ContactDelete.IntegrationTests.Configurations.Factories.Extensions;

namespace Postech.GroupEight.TechChallenge.ContactDelete.IntegrationTests.Configurations.Factories
{
    [ExcludeFromCodeCoverage]
    public class ContactDeleteAppWebApplicationFactory(string rabbitMqConnectionString) : WebApplicationFactory<Program>
    {
